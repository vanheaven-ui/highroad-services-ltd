        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          >
            ...
            <p className="text-xl font-body text-gray-700 leading-relaxed">
              HighRoad Services Ltd is the trusted{" "}
              <strong>evidence-based</strong> economic consultancy. We empower
              governments, international NGOs, and businesses by delivering{" "}
              <strong>strategic policy advice</strong> and{" "}
              <strong>analytical quality</strong> that translates complex data
          ...
          <div className="space-y-8 md:order-2 lg:order-1 lg:text-right">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                recurring flaw:
                <strong> high-stakes decisions</strong> were often based on weak
                data—leading to stalled development and misallocated resources.
              </p>
            </motion.div>
